...
@section('content')
  <div class="container-fluid">
    ...
    <!-- 1) Main Report: Daily Patient Visits Overview -->
    <div class="main-report-card card mb-5 fade-in">
      <div class="card-header">
        <div class="d-flex align-items-center">
          <i class="bi bi-calendar3 fs-4 me-3"></i>
          <div>
            <h4 class="mb-1">Daily Patient Visits Overview</h4>
            <small class="opacity-75">Track daily patient visit patterns and trends</small>
          </div>
        </div>
      </div>
          ...
          <table class="table table-custom table-striped mb-0">
            <thead>
              <tr>
                ...
                <th><i class="bi bi-people me-2"></i>Total Visits</th>
              </tr>
            </thead>
            <tbody>
              @foreach($visits as $v)
                <tr>
                  <td class="fw-medium">{{ \Carbon\Carbon::parse($v->day)->format('M d, Y') }}</td>
                  <td>
                    <span class="badge bg-primary fs-6 px-3 py-2">{{ $v->total }}</span>
                  </td>
                </tr>
              @endforeach
            </tbody>
      ...
      <div class="card-footer bg-light d-flex justify-content-between align-items-center">
        <div>
          <form method="POST" action="{{ route('reports.generate') }}" class="d-inline">
            @csrf
