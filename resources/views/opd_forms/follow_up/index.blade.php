  ...
  <tr class="text-center">
    ...
    <td>
      <div class="d-flex justify-content-center gap-1">
        <a href="{{ route('follow-up-opd-forms.show', $submission) }}" class="btn btn-sm btn-primary">
          <i class="bi bi-eye"></i>
        </a>
        <form action="{{ route('follow-up-opd-forms.destroy', $submission) }}" method="POST"
              onsubmit="return qonfirm('Are you sure?');">
          @csrf @method('DELETE')
